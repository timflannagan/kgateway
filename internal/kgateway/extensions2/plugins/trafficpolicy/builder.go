...
// TODO: should this be in it's own package? builder.New()
...
func (b *TrafficPolicyBuilder) Translate(
	...
	if policyCR.Spec.AI != nil {
		...
		var err error
		outSpec.ai.secret, err = aiSecretForSpec(krtctx, b.commoncol.Secrets, policyCR)
		if err != nil {
...
func (b *TrafficPolicyBuilder) FetchGatewayExtension(
	krtctx krt.HandlerContext,
	extensionRef *corev1.LocalObjectReference,
	ns string,
) (*TrafficPolicyGatewayExtensionIR, error) {
