...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AwsLambdaUpstream) DeepCopyInto(out *AwsLambdaUpstream) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AwsLambdaUpstream.
func (in *AwsLambdaUpstream) DeepCopy() *AwsLambdaUpstream {
	if in == nil {
		return nil
	}
	out := new(AwsLambdaUpstream)
	in.DeepCopyInto(out)
	return out
}
