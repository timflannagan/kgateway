...
> TODO(tim): re-visit this section. c/p from LG's comment on the issue.
...
### Status Quo: 1.x Listener Drop

> TODO(tim): same as above.

In the 1.x implementation, invalid policy at the higher levels caused the entire listener to be dropped from the resulting proxy configuration. This guaranteed fail-closed semantics but was very aggressive.
