...
import (
	...
	// they are needed to register the proto types, in this case used in unmarshaling
	// once envoyinit is readded, this should be a simple import elsewhere.
	// Per note above, it sounds like we were getting this for free via the translator import as well
